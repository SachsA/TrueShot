...
public:
    ...
    // Movement audio
    void onFootstep(const glm::vec3& position, Audio::SurfaceMaterial surface, float movementSpeed,
...
private:
    ...
    void scheduleDelayedSound(const std::string& soundName, const glm::vec3& position, float delay,
                              float volume);
