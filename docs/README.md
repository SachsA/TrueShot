...
| ------------------------------------------------------ | ----------------------------------- | ------------------------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| [001](adr/0001-render-api.md)                          | Render API choice                   | Accepted _(interim, revisit Phase 4)_ | 0                         | OpenGL 3.3 Core now, because it's the only API that ships on all three mandatory platforms without a rewrite.        |
