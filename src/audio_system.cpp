...
float AudioSystem::calculateDistance(const glm::vec3& sourcePos,
...
float AudioSystem::calculateVolume(const AudioSource& source) const {
    ...
    float attenuation = AudioUtils::calculateRolloff(distance, source.settings3D.minDistance,
    ...
    return source.volume * attenuation * getCategoryVolume(source.category) *
           m_Listener.masterVolume;
}
...
std::string getSurfaceSoundName(Audio::SurfaceMaterial material, const std::string& action) {
    ...
    switch (material) {
    case Audio::SurfaceMaterial::CONCRETE:
        materialName = "concrete";
        break;
    case Audio::SurfaceMaterial::METAL:
        materialName = "metal";
        break;
    case Audio::SurfaceMaterial::WOOD:
        materialName = "wood";
        break;
    case Audio::SurfaceMaterial::GRAVEL:
        materialName = "gravel";
        break;
    case Audio::SurfaceMaterial::GRASS:
        materialName = "grass";
        break;
    case Audio::SurfaceMaterial::WATER:
        materialName = "water";
        break;
    default:
        materialName = "concrete";
